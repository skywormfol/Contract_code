...
contract Rubixi {
        ...
        //Sets creator.!!!!!!!!!!!!!!should be initiated the creator of contract!!!!!!!!!!!!!!
        ...
        function collectAllFees() onlyowner payable{
        ...
        function collectFeesInEther(uint _amt) onlyowner payable{
                _amt *= 1 ether;
