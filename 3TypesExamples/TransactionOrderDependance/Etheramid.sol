//the "make smart contract smarter" example.
//https://github.com/etherroot/etheramid
//https://etherscan.io/address/0xfeeb8A968F0d7FD58E29FBfC525051f50eE2FeDC#code
...
contract Etheramid {
    ...
    function enter(address inviter) public {
        ...
        //check amount, sender and invater existance. this send flow is different with the following send flow.
        ...
        uint rest = amount;
        uint level = 1;
	//these send flows are identified, but don't affect the intended payouts and recipients.
